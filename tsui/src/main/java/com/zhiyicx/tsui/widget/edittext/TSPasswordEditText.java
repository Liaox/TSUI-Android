 ...
 */
public class TSPasswordEditText extends AppCompatEditText {
    // 当前密码可见时的图片
    ...
    public TSPasswordEditText(Context context) {
        this(context, null);
    }

    public TSPasswordEditText(Context context, AttributeSet attrs) {
        // 这里构造方法也很重要，不加这个很多属性不能再XML里面定义
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public TSPasswordEditText(Context context, AttributeSet attrs, int defStyle) {
