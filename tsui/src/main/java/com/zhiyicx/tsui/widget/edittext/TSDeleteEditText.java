 ...
 */
public class TSDeleteEditText extends AppCompatEditText implements OnFocusChangeListener, TextWatcher {
    ...
    public TSDeleteEditText(Context context) {
        this(context, null);
    }

    public TSDeleteEditText(Context context, AttributeSet attrs) {
        // 这里构造方法也很重要，不加这个很多属性不能再XML里面定义
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public TSDeleteEditText(Context context, AttributeSet attrs, int defStyle) {
